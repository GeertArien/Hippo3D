...
namespace Mantis {
	...
	namespace Controls {
		...
		public:
			...
			void ProcessInput(const Input::InputManager& inputManager, GFX::Camera& camera);
		...
		private:
			...
			void ProcessFPSMovement(const Input::InputManager& inputManager, GFX::Camera& camera);

			void ProcessMouseMove(const Input::InputManager& inputManager, GFX::Camera& camera);

			void ProcessScroll(const Input::InputManager& inputManager, GFX::Camera& camera);
